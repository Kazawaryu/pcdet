...
def parse_config():
    ...
    parser.add_argument('--extra_tag', type=str, default='C_S4_O', help='extra tag for this experiment')
    parser.add_argument('--ckpt', type=str, default='/home/jiazx_ug/OpenPCDet/output/kitti_models/pointpillar_copy2/C_S2/ckpt/checkpoint_epoch_160.pth', help='checkpoint to start from')
